...
namespace CatStudio
{
    class PyGenerator : BaseLanguageGenerator
    {
        public PyGenerator()
        {
            ...
            this.START_UP_STATEMENT                         = "core = win32com.client.Dispatch(\"OpenTwebst.Core\")\n" + "browser = core.StartBrowser(\"{0}\")\n";
        ...
        {
            return String.Format(this.pyDecoration, code);
        }
        ...
        private readonly String pyDecoration = 
@"# To run this script, install ActivePython from http://www.activestate.com/activepython (x86 version).
# It comes with Win32 and COM packages.
