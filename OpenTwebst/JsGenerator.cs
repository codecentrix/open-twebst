...
namespace CatStudio
{
    class JsGenerator : BaseLanguageGenerator
    {
        public JsGenerator()
        {
            ...
            this.START_UP_STATEMENT                         = "var core    = new ActiveXObject('OpenTwebst.Core');\n" + "var browser = core.StartBrowser('{0}');\n";
            ...
            this.SELECT_MULTIPLE_DECLARATION                = "var ";
            ...
            // For Win64 add a comment on how to start a .js script as 32 bit process.
            if (CatStudioConstants.IsWin64)
            {
                this.START_UP_STATEMENT = "// On Windows 64 bit use the command line below to launch the script as a 32 bit process:\n// %windir%\\SysWOW64\\wscript.exe TwebstScript.js\n\n" + this.START_UP_STATEMENT;
            }
            else
            {
                this.START_UP_STATEMENT = "// Use the command line below to launch the script (or just double click the .js file):\n// %windir%\\system32\\wscript.exe TwebstScript.js\n\n" + this.START_UP_STATEMENT;
            }
        }
